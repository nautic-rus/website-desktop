    ...
    switch (this.lang){
      case 'EN': {
        switch (value){
          ...
          case 'Наши проекты': return 'Projects';
          ...
          case 'Свидетельства о соответствии предприятия. Документы, подтверждающие, что оказываемые предприятием услуги соответствуют требованиям Регистра Судоходства.': return 'The main documents issued by the Russian Maritime Register of Shipping is a Type Approval Certificate. The type approval certificate is a documents certifying that the properties, parameters and characteristics of the type material or product issued by the manufacturer comply with the requirements of the rules of the Russian Maritime Register of Shipping for use on vessels and objects of a technical supervision for the intended purpose. A type approval certificate is required for companies that manufacture the products used in the maritime sphere, shipping and working on seas and rivers.';
          ...
          case 'Напишите нам': return 'Write to us';
          case 'Фамилия*': return 'Surname*';
          case 'Имя*': return 'Name*';
          case 'Телефон*': return 'Phone*';
          case 'Почта*': return 'Email*';
          case 'Отправить': return 'Send';
          case 'Требуемый опыт работы:': return 'Required work experience:';
          case 'Условия работы:': return 'Working conditions:';
          case 'Обязанности:': return 'Responsibilities:';
          case 'Требования:': return 'Requirements:';
          case 'Полная занятость, гибкий график': return 'Full-time, flexible schedule';
          case 'Отправить резюме': return 'Send resume';
          case 'ВАКАНСИИ': return 'VACANCIES';
          case 'Перейти к вакансии': return 'Go to the vacancy';
          case '': return '';
          case '': return '';
          case '': return '';
          case '': return '';
