...
export class ProjectDetailsComponent implements OnInit {
  ...
  constructor(private s: ShipManagerService, private lb: Lightbox, private route: ActivatedRoute, public t: TranslationService, public device: DeviceDetectorService) { }
