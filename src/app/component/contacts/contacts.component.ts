...
export class ContactsComponent implements OnInit {
  ...
  fillEmployees(): void{
    ...
    if (this.t.lang === 'RU'){
        ...
        this.employees[++counter] = new Employee('Вячеслав', 'Здюмаев', 'zdyumaev.jpg', ' zdyumaev@nautic.ru', 'Главный Конструктор', 'MANAGEMENT');
      ...
      this.employees[++counter] = new Employee('Vyacheslav', 'Zdyumaev', 'zdyumaev.jpg', ' zdyumaev@nautic.ru', 'Сhief Designer', 'MANAGEMENT');
