...
export class ContactsComponent implements OnInit {
  ...
  fillEmployees(): void{
    ...
    if (this.t.lang === 'RU'){
        ...
        this.employees[++counter] = new Employee('Антон', 'Мамонов', 'mamonov.jpg', 'mamonov@nautic-rus.ru', 'IT-отдел', 'IT');
        ...
        this.employees[++counter] = new Employee('Сергей', 'Шабанов', 'shabanov.jpg', 'shabanov@nautic-rus.ru', 'Системный отдел', 'SYSTEMS');
        this.employees[++counter] = new Employee('Евгений', 'Воронков', '7.jpg', 'voronkov@nautic-rus.ru', 'Системный отдел', 'SYSTEMS');
      ...
      this.employees[++counter] = new Employee('Sergei', 'Shabanov', 'shabanov.jpg', 'shabanov@nautic-rus.ru', 'Systems department', 'SYSTEMS');
      this.employees[++counter] = new Employee('Evgenii', 'Voronkov', '7.jpg', 'voronkov@nautic-rus.ru', 'Systems department', 'SYSTEMS');
